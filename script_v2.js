...
function orderNowWhatsApp() {
    ...
    const finalPrice = globalProductData.final_dzd || globalProductData.price_dzd || 0;
    const productName = globalProductData.title || 'منتج من AliExpress';
    
    const msg = `مرحباً متجر Kouki Shop 👋\nأريد تأكيد طلب هذا المنتج من فضلك:\n📦 المنتج: ${productName}\n💰 السعر: ${finalPrice.toLocaleString()} دج\n🔗 الرابط: ${globalProductData.url}`;
